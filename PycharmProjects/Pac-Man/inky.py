...
class Inky(Sprite):
    ...
    def __init__(self, ai_settings, screen):
        ...
        image = sprite_sheet.get_image(128, 192, 32, 32)
        self.redr.append(image)
        image = sprite_sheet.get_image(128, 224, 32, 32)
        self.redr.append(image)
        ...
        image = sprite_sheet.get_image(160, 96, 32, 32)
        self.redu.append(image)
        ...
        sprite_sheet = SpriteSheet('images/spreadsheet6.png')
